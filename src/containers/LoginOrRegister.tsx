...
import { manualLogin, signUp, toggleLoginMode } from '../actions/actionUsers';
const styles = require ('../css/components/login');
const hourGlassSvg = require ('../images/hourglass.svg');

const cx = classNames.bind(styles);

class LoginOrRegister extends React.Component<any,any> {
  /*
  ...
  handleOnSubmit(event) {
    ...
    const email = ReactDOM.findDOMNode(this.refs.email).nodeValue;
    const password = ReactDOM.findDOMNode(this.refs.password).nodeValue;
  ...
  render() {
    ...
    manualLogin: React.PropTypes.func.isRequired,
    signUp: React.PropTypes.func.isRequired,
    toggleLoginMode: React.PropTypes.func.isRequired
    };
}
