...
const styles = require ('css/components/about');
...
const AboutContainer = () => {
  return (
    <div className={cx('about')}>
      <h1 className={cx('header')}>About Tournament</h1>
      ...
      <div className={cx('contribute')}>
        <p>Want to contribute? Help us out!
          ...
          <a target="_blank" href="https://github.com/idriss92/tournament">this repo</a>
        &nbsp;could be improved, please create an issue&nbsp;
          <a target="_blank" href="https://github.com/idriss92/tournament/issues">here</a>!
        </p>
      </div>
    </div>
  );
